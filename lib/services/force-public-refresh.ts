...
const CACHE_KEYS: Record<Exclude<PublicRefreshTarget, `global-market:${string}`>, string[]> = {
  ...
  "market-strategy-holdings": ["market-strategy:holdings-v1"],
  "funds-breakdown": ["market:funds-breakdown-v1"],
  "mf-top-holdings": ["market:mf-top-holdings-v1"],
  "fipi-lipi": ["market:fipi-lipi-v9"],
  youtubers: ["youtube:videos:selected"],
  "board-meetings": ["explore:board-meetings:v3"],
