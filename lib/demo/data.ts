...
export const DEMO_NOTIFICATIONS: AppNotification[] = [
  {
    ...
    user_id: DEMO_USER.id,
    type: "ALERT",
    title: "OGDC is getting close to your alert price",
    body: "Your alert is set at Rs 200.00. OGDC is now Rs 178.45.",
    symbol: "OGDC",
  ...
  },
  {
    ...
    user_id: null,
    type: "MARKET",
    title: "PSX market is open",
    body: "Trading has started. Prices, your portfolio, and alerts are now updating live.",
    symbol: null,
  ...
  },
  {
    ...
    user_id: DEMO_USER.id,
    type: "ALERT",
    title: "Price alert: LUCK crossed above Rs 1,200.00",
    body: "LUCK is now Rs 1,205.30 — Rs 5.30 above your alert price.",
    symbol: "LUCK",
  ...
  },
  {
    ...
    user_id: null,
    type: "MARKET",
    title: "PSX is closed for today",
    body: "The market is closed. The next session starts tomorrow at 09:30 PKT.",
    symbol: null,
